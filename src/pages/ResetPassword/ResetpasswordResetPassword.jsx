...
export default function ResetPassword() {
  return (
    <div className="flex flex-col min-h-screen h-screen bg-gray-900_01 items-center justify-center">
      ...
      <div className="flex w-full flex-col items-center justify-center py-4 lg:py-8 md:py-5 sm:py-4 h-full">
        <div className="container-xs flex flex-col items-center gap-[32px] px-14 lg:px-5 md:px-5 sm:gap-[20px] sm:px-4">
          <Heading
            size="heading3x1"
            as="h1"
            className="font-poppins font-bold text-white-a700 text-3xl md:text-4xl lg:text-5xl"
          >
            Reset Password
          </Heading>
          <div className="flex w-full justify-center lg:w-full md:w-full">
            <div className="flex w-full max-w-md flex-col items-center rounded-[10px] bg-gray-900_01 px-[20px] py-2 sm:px-4">
              <a href="#" className="lg:text-[27px] md:text-[26px] sm:text-[24px]">
                <Text size="text3x1" as="p" className="font-opensans text-amber-600">
                  Forgot password
                </Text>
              </a>
              <Heading
          ...
          <div className="mt-5 flex flex-col items-center gap-4 max-w-md w-full">
